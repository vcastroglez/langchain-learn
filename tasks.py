...
class MeetingPrepTasks:
	...
	@staticmethod
	def industry_analysis_task(agent, meeting_participants, meeting_context):
		return Task(
			description=dedent(f"""\
	...
	@staticmethod
	def meeting_strategy_task(agent, meeting_context, meeting_objective):
		return Task(
			description=dedent(f"""\
	...
	@staticmethod
	def summary_and_briefing_task(agent, meeting_context, meeting_objective):
		return Task(
			description=dedent(f"""\
